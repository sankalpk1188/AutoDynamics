                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped" style="overflow-x: auto;">
                                ...
                                @foreach($gallery as $key => $row)
	                                <tr>
	                                    <td>{{ method_exists($gallery, 'firstItem') ? ($gallery->firstItem() + $key) : ($key + 1) }}</td>
	                                    <td>{{ $row->name }}</td>
                                        <td>{{ $row->title ?? '-' }}</td>
                                        <td><a href="{{ asset('assets/images/gallery/'.$row->image) }}"><img src="{{ asset('assets/images/gallery/'.$row->image) }}" width="100px"></a></td>
